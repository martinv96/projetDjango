...
SECRET_KEY = 'django-insecure-3xi=va3b4o5&^j!kozbz-4l%g05d)iqju_ezy)$+v3^04@zlgr'
...
if ENVIRONMENT == 'production':
    # PostgreSQL config for Render (ou autre prod)
    DATABASES = {
        'default': {
...
INSTALLED_APPS = [
    ...
    'widget_tweaks',
    'monapp',  # Assurez-vous que votre application monapp est incluse ici
]
